...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td class="lbl">
            Supplier Name:</td>
         <td style="text-align: left">
            <asp:TextBox ID="txtsupplier" runat="server" placeholder="Enter Supplier Name!!" 
              CssClass="txt"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                ControlToValidate="txtsupplier" ErrorMessage="Enter Supplier Name" ForeColor="Red"></asp:RequiredFieldValidator>
        </td>
    </tr>
         <tr>
        <td class="lbl">
            Shipper Name:</td>
         <td style="text-align: left">
            <asp:TextBox ID="txtshipper" runat="server" placeholder="Enter Shipper Name!!" 
              CssClass="txt"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                ControlToValidate="txtshipper" ErrorMessage="Enter Shipper Name" ForeColor="Red"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td class="style14">
